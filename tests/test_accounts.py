...
class TestAccounts:
    @pytest.mark.parametrize(
        ...
        (
            ...
            ('16kEGFeyNHmQqpMXwcfRtu2tBMwgsu7PdTF3EQzCgNwJhMUG', '0xfe255de774a4fee89844342b558e8817d8914701490f991fbd97925b490268e4'),
            ('7PLnYkmNacsCgWqm1A5vgfnetvxDLSnBWi9JzUWArFQ2RiZV', '0xfe255de774a4fee89844342b558e8817d8914701490f991fbd97925b490268e4'),
            ('14zJrZTexUcA1NZzQPPLusPppmsejSPQHU39yCNzLWSempGP', '0xb069cabc2ba7970d0af3aaee3111446290b884f4fcd87799138daa39785e072d'),
            ...
            ('0x6d6f646c6f6d6e69706f6f6c0000000000000000000000000000000000000000', f'0x{(b"modl" + b"omnipool").hex():<064}'),
        ),
    )
